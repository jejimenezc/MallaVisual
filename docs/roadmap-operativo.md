...
| Proximo PR recomendado | `PR-1.3 ampliar cobertura de flujos de viewer y publicacion` |
...
- Validado: 2026-04-08 - PR/commit: pendiente tras commit de cierre de `PR-1.2` - Nota: `PR-1.2` distingue mejor piezas referenciadas y snapshots en la malla con bordes suaves e iconos persistentes; desbloquea `PR-1.3`.
